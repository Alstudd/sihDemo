...
export default function ManageProducts() {
  return (
    <div className="relative xl:mb-[12.8rem] mb-16">
      <img
      ...
      <div className="flex flex-col gap-6 sm:ml-24 ml-0 2xl:w-[80rem] xl:w-[72.5rem] lg:w-[50rem] md:w-[41rem] w-[28rem]">
        <h1 className="pt-16 lg:text-6xl md:text-5xl text-4xl font-extrabold md:leading-normal leading-tight sm:ml-0 ml-24 w-full">
          Manage Your <span className="gradText1">Products</span>
        </h1>
        <p className="ml-10 text-xl font-medium text-[#616161]">Get Business Insights Tools, Manage Your Products, Export With DNK</p>
        <img className="ml-8 w-full" src="/Home/manageProd.svg" alt="" />
      </div>
